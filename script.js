        ...
        .then(data => {
            ...
            if (pathArr.length > 0) {
                ...
                setTimeout(() => {
                     ...
                     map.setViewport(viewport, { enableAnimation: true, margins: [20, 20, 20, 340] }); 
                }, 100);
...
function getColorByStrong(strong) {
    if (!strong) return "rgb(153, 153, 153)"; 
    if (strong.includes("超强台风")) return "rgb(255, 0, 0)";     
    if (strong.includes("强台风"))   return "rgb(255, 150, 250)";  
    if (strong.includes("台风"))     return "rgb(255, 197, 12)";   
    if (strong.includes("强热带风暴")) return "rgb(255, 250, 50)"; 
    if (strong.includes("热带风暴"))   return "rgb(0, 137, 255)";  
    if (strong.includes("热带低压"))   return "rgb(67, 250, 91)";  
